...
from keyboards.keyboards import geo_or_text_kb, dest_kb, cancel_kb, main_menu_kb, confirm_address_kb, addr_not_found_kb, city_picker_kb, date_picker_kb, time_picker_kb, seats_kb
